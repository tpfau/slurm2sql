...
class Eff(Base):
    ...
    NCPUS = Column(Integer)
    CPUeff = Column(Float)
    cpu_s_reserved = Column(Float)
    cpu_s_used = Column(Float)
    MemReq = Column(Float)
    AllocMem = Column(Float)
    TotalMem = Column(Float)
    MaxRSS = Column(Float)
    MemEff = Column(Float)
    mem_s_reserved = Column(Float)
    NGpus = Column(Float)
    GPUType = Column(String)
    gpu_s_reserved = Column(Float)
    gpu_s_used = Column(Float)
    GpuEff = Column(Float)
    GpuMem = Column(Float)
    MaxDiskRead = Column(Integer)
    MaxDiskWrite = Column(Integer)
